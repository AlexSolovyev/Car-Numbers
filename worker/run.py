...
from ocr_stream import OcrStream
from visualize_stream import VisualizeStream
...
class CNDProject:
    def __init__(self, name, video_path, save_path, fps=60, frame_size=(1600, 800), coord=(500, 500)):
        self.name = name
